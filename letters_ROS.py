...
# this script was written using https://github.com/hello-robot/stretch_tutorials/blob/master/stretch_body/jupyter/inverse_kinematics.ipynb as reference
...
if __name__ == '__main__':
    ...
    if letter in LETTER_WAYPOINTS.keys():
        ...
        urdf_path = ''  # TODO: download stretch URDF and put it into repo somewhere
